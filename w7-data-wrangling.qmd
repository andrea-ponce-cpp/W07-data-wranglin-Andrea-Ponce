...
-   To add code chunk, use the keyboard shortcut 'Ctrl + Alt + I'
...
Note: Use 'Shift + Alt + I'for multi-cursor activation, then press 'home' to move cursor to the front
...
flights |>
  ...
  geom_col(fill ="#FF1D8D", show.legend = FALSE) +
  coord_flip() +
  labs(
      x = "Month",
      y = "# of Flights",
